...
The full write-up is [`outputs/results.md`](outputs/results.md), with a figure-by-figure guide in [`outputs/figures.md`](outputs/figures.md).
...
An AI coding assistant (Anthropic's Claude) helped implement some of the code and draft the initial documentation. Adam Holt 
